...
public enum MySqlStatementType {
	...
	//assign
	ASSIGN(SQLSetStatement.class.getName()),
	//select into
	SELECTINTO(MySqlSelectIntoStatement.class.getName()),
	//case
	CASE(MySqlCaseStatement.class.getName()),
	//loop
	LOOP(MySqlLoopStatement.class.getName()),
	//reapeat
	REPEAT(MySqlRepeatStatement.class.getName()),
	//leave
	LEAVE(MySqlLeaveStatement.class.getName()),
	UNDEFINED,
	;
