...
public class MySqlExecuteProcedureTest1 extends MysqlTest {
    ...
    public void test_0() throws Exception {
    	String sql="create or replace procedure sp_if()"+
				" begin"+
				" declare @x int;"+
				" set @x = 10;"+
				" if @x>1 then"+
    ...
    public void test_3() throws Exception {
    	String sql="create or replace procedure sp_while()"+
				" begin"+
				" declare @x int;"+
				" set @x=10;"+
				" while @x>0 do"+
    ...
    public void test_4() throws Exception {
    	String sql="create or replace procedure sp_loop()"+
				" begin"+
				" declare @x int;"+
				" loop"+
    ...
    public void test_5() throws Exception {
    	String sql="create or replace procedure sp_repeat()"+
				" begin"+
				" declare @x int;"+
				" set @x=0;"+
				" repeat"+
